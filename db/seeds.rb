...
Driver.create!(
				...
				driver_license_image_id: File.open("./app/assets/images/license_image.png") ,
				is_active: true,
				terms: true,
				password: "driver1",
...
Ad.create!(
				...
				content: "契約更新あり！<br>継続的に弊社の広告業務を行っていただけるドライバーさんを探しています。<br>広告ポスターは弊社から支給させていただきます。多くのドライバー様からのご応募をお待ちしております。",
...
Ad.create!(
				...
				content: "契約更新あり！<br>リブランディングに伴い弊社の広告ポスターを宣伝していただきます。。多くのドライバー様からのご応募をお待ちしております。",
...
Ad.create!(
				...
				heading: "",
				content: "長長期契！約契約更新あり！<br>年末に行うキャンペーンを、長期的に行っていただけるドライバーさんを探しています。<br>広告ポスターは弊社から支給させていただきます。多くのドライバー様からのご応募をお待ちしております。",
